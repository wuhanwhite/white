...
<h2>太和OCR身份证自动识别文字工具</h2>
<form enctype="multipart/form-data" method="post" action="idcard.php">  
...
<div id="addCommodityIndex">
            ...
            <div class="input-group row">
                <div class="col-sm-3">
                    <label>请点击下图上传需要识别的身份证照片</label>
                </div>
                <div class="col-sm-9 big-photo">
                	<div id="preview">
                        <img id="imghead" border="0" src="img/upload.png" width="90" height="90" onclick="$('#previewImg').click();">
                     </div>         
                    <input type="file" onchange="previewImage(this)" style="display: none;" id="previewImg" name="idcardfile">
