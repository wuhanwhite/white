<?php  
    ...
    if(is_uploaded_file($_FILES['myfile']['tmp_name'])) {  
        ...
        //我们给每个用户动态的创建一个文件夹  
        $user_path=$_SERVER['DOCUMENT_ROOT']."/baiduocr/upload/accurate".$username;  
        //判断该用户文件夹是否已经有这个文件夹  
    ...
    function ocrstart($filename){
			...
			//开始识别
			$url1='http://weixin.tahanmall.com/baiduocr/upload/accurate/';
			$url2='upload/accurate/'.$filename;
			
			
			$json3= json_encode($aipOcr->basicAccurate(file_get_contents($url2)), JSON_PRETTY_PRINT);
