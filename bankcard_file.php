...
<html lang="en" class="no-js">
	<head>
		...
		<title>太和OCR银行卡自动识别文字工具</title>
		<meta name="description" content="太和银行卡自动识别文字工具" />
		<meta name="keywords" content="太和OCR银行卡自动识别文字工具" />
...
<body >
<h2>太和OCR银行卡自动识别文字工具</h2>
<form enctype="multipart/form-data" method="post" action="bankcard.php">  
