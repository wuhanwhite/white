...
<body >
<h2>太和OCR图片自动识别文字工具</h2>
<form enctype="multipart/form-data" method="post" action="webimg.php">  
...
<div id="addCommodityIndex">
            ...
            <div class="input-group row">
                ...
                <div class="col-sm-9 big-photo">
                    ...
                    <input type="file" onchange="previewImage(this)" style="display: none;" id="previewImg" name="webimgfile">
